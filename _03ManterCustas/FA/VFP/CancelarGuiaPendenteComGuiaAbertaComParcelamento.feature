#Author: Sheila Lopes
#Date: 06/09/2017
#Keywords Summary : Cancelar, Guia, Pendente, Aberta, Parcelamento.
#Feature: CancelarGuiaPendenteComGuiaAbertaComParcelamento
#Description: Essa feature tem o objetivo de validar o cancelamento de guias quando há uma guia
#pendente e uma guia aberta com parcelamento.

@Funcionalidade
Feature: Cancelar Guia Pendente Com Guia Aberta Com Parcelamento
...
# Ponto de Verificação 1, campo TIPO = 'Guia', campo PARCELA =  '1 de 2', campo SITUACAO = 'Aberta'
  ...
  @Cenario3
  Scenario: CANCELAR GUIA PENDENTE COM PARCELAMENTO
