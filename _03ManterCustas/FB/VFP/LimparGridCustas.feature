...
#Consultar por Finalidade, Consultar por Situação, Sair, Pesquisar, Limpar
#Feature: LimparGridCustas
#Description: Essa feature tem a finalidade de validar a funcionalidade do botão Limpar na grid CUSTAS.

@Funcionalidade
Feature: Limpar Grid Custas
  ...
  Scenario: Limpar Grid Custas
    ...
    Then valido campo SITUACAO "Aberta"
    Then visualizo parcelas no rodapé da grid de custas "Ver 1 - 4 de 4"
    When clico botao LIMPAR Grid Custas
    Then valido combo TIPO DE CUSTAS "Selecione"
    And valido combo CONSULTAR POR PAGANTE "Selecione"
    And valido combo CONSULTAR POR FINALIDADE "Selecione"
    And valido combo CONSULTAR POR SITUACAO "Selecione"