...
Ter executado @Scenario4 da PesquisaProcesso_JEFP.feature
...
@Scenario2
 ...
 Examples:
  ...
  | Procedimento do Juizado Especial Cível  |   Outros                        |   Adimplemento e Extinção :: Pagamento - 15624     |
  | Procedimento do Juizado Especial Cível  |   Servidor Público Civil        |   Aposentadoria :: Compulsória - 13472             |
  | Procedimento do Juizado Especial Cível  |   Servidor Público Militar      |   Militar :: Pensão - 13555                        |
