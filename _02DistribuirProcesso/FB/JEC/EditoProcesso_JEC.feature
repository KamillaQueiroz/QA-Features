...
Feature: Edição de Processo
  ...
  Ter executado @Scenario4 da PesquisaProcesso_JEC.feature
...
#No "manterprocesso1gman?id=xxxx" os 'XXXX são referentes ao valor do ID do processo
  ...
  Scenario Outline: Editar Processo - Alterar valores Aba Classificação
    ...
    Examples:
      ...
      | Incidente de Desconsideração de Personalidade Jurídica  |   Cobrança – Aluguel              |   Espécies de Contratos :: Cobrança de Aluguéis - Sem Despejo - 12629                   |
      | Incidente de Desconsideração de Personalidade Jurídica  |   Cobrança – Contratos/Discussão  |   Atos Unilaterais :: Promessa de Recompensa - 14156                                    |
      | Incidente de Desconsideração de Personalidade Jurídica  |   Consumidor – Energia Elétrica   |   Indenização por Dano Moral :: Inclusão Indevida em Cadastro de Inadimplentes - 11336  |
