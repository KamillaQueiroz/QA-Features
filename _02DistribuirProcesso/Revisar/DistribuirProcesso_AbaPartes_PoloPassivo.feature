...
@tag
Feature: Adicionano de Polo Passivo

@basico
Scenario Outline: Acessar modal ASSOCIAR PARTE AO PROCESSO - POLO PASSIVO
...
Examples:
	...
	|	AutoName2	|	Feminino	|	00339635096	|	12345678	|	Rio Grande do Sul	|	Mestrado		|	Solteiro	|	Advogado	|	Joao	|	Maria	|	null	|	Brasil	|	RS	|	Porto Alegre	|
...
@fluxo
Scenario Outline: adicionar Polo Passivo
Given acesso eThemis USUARIO "et1g-servidor" SENHA "12345678"
And crio novo processo HOME ATUACAO "Comarca de Porto Alegre - 10º Juizado Especial Cível"
And preencho aba CLASSIFICACAO CLASSE "Procedimento do Juizado Especial Cível" TIPO PEDIDO "Acidente de Trânsito – Reparação de Danos" ASSUNTO "Indenização por Dano Material :: Acidente de Trânsito - 11319"
When adiciono POLO PASSIVO "<nome>", "<sexo>", "<cpf>", "<rg>", "<ufRg>", "<grausInstrucao>", "<estadoCivil>", "<profissao>", "<nomePai>", "<nomeMae>", "<data>", "<pais>", "<uf>", "<cidade>", "<enderecoPais>", "<cep>", "<enderecoNumero>", "<tipoEndereco>", "<telefoneTipo>", "<ddd>", "<telefoneNumero>", "<email>", "<numeroOAB>", "<advogadoUf>", "<tipoAdvogado>"
Then verifico GRID PARTES
